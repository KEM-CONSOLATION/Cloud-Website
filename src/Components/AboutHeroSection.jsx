      ...
      <div className=" ">
        ...
        >
          <div className="max-w-[758px] ">
            <p className="font-Satoshi text-[48px] text-[#061C60] md:leading-[60px]">
              <Typewriter
                words={[
                  "       A creative engine providing bespoke solutions for all your digital demands.",
                ]}
                loop={0}
                cursor
                cursorStyle="_"
            ...
            <p className="max-w-[600px] font-Satoshi-regular  text-[20px] text-[#575B5E] my-[32px]">
